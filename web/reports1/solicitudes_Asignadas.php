...
$this->Ln(2);
$this->Cell(0,5,utf8_decode('Reporte de Solicitudes Aprobadas'), 0, 0, 'C', false);
...
if ($temp_ff ==0 and $temp_fi ==0 and $temp_tipo==0)
    ...
    $datos = $conexion->get_results("SELECT de.nombre as dependencia,sts.nombre,ss.descripcion,ss.fecha_recepcion, to_char(ss.fecha_recepcion,'DD-MM-YYYY') as fecha_recepcion, to_char(ss.fecha_requiere,'DD-MM-YYYY') as fecha_requiere
