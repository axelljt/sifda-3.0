...
$this->SetWidths(array(5, 50,12,17,17,12,40,32));
$this->Row(array('N',utf8_decode('Descripcion'),utf8_decode('Meta'),utf8_decode('Realizadas'),utf8_decode('Porcentaje (%)'),utf8_decode('Costo ($)'),utf8_decode('Indicador'),utf8_decode('Generado')));
...
left outer join sifda_recurso_servicio sri on sio.id = sri.id_informe_orden_trabajo where sts.id =s.id ";
  ...
  $pdf->Row(array($item,utf8_decode($value2->descripcion),utf8_decode($value2->meta_anual),
			utf8_decode($value2->finalizadas),utf8_decode($value2->porcentaje),
			utf8_decode($value2->costo),utf8_decode($value2->indicador),
