...
$objPHPExcel->getActiveSheet()->setTitle("Solicitudes Ingresadas"); //establecer titulo de hoja
...
$objPHPExcel->getActiveSheet()->SetCellValue("D$fila", "Período del ".$temp_fi.' al '.$temp_ff );
$objPHPExcel->getActiveSheet()->getStyle("D$fila")->getFont()->setBold(true); //negrita
...
$objPHPExcel->getActiveSheet()->setSharedStyle($subtitulo, "E$fila");//establecer estilo
...
$objPHPExcel->getActiveSheet()->getStyle("E$fila")->getFont()->setBold(true);
 ...
 $fila1 = $fila1 +1;
 $objPHPExcel->getActiveSheet()->getStyle("D$fila1")->getFont()->setBold(true); //negrita
 $objPHPExcel->getActiveSheet()->getStyle("E$fila1")->getFont()->setBold(true); //negrita
