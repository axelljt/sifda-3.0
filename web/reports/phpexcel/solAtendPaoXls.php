...
$objPHPExcel->getActiveSheet()->SetCellValue("E$fila", 'Indicador');
$objPHPExcel->getActiveSheet()->SetCellValue("F$fila", 'Generado');
...
foreach ($datos as $value) {
    ...
    $objPHPExcel->getActiveSheet()->mergeCells("A$fila1:F$fila1"); //unir celdas
  ...
  $objPHPExcel->getActiveSheet()->SetCellValue("E$fila1", "$value2->indicador");
  $objPHPExcel->getActiveSheet()->SetCellValue("F$fila1", "$value2->generado");
