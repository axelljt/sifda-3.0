...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $temp_fi = $_REQUEST['fi'];
        $temp_ff = $_REQUEST['ff'];
        $temp_depn = $_REQUEST['depn'];
        $temp_estn = $_REQUEST['estn'];
...
//$this->Cell(0,25,utf8_decode('Reporte de Solicitudes Ingresadas'), 0, 0, 'C', false);
        $this->Cell(0, -7, utf8_decode($temp_depn), 0, 0, 'C', false);
//$this->Cell(-155,-7,utf8_decode(', '), 0, 0, 'C', false);
//$this->Cell(250,-7,utf8_decode($temp_estn), 0, 0, 'C', false);
        $this->Ln(2);
        $this->Cell(0, 5, utf8_decode('Reporte de Solicitudes Finalizadas'), 0, 0, 'C', false);
...
$temp_est = $_REQUEST['est'];

$sql = "SELECT sts.nombre,count(sts.nombre) as cuenta
